...
__decorate([
    typeorm_1.Column({ nullable: true }),
    __metadata("design:type", Boolean)
], User.prototype, "isTeacher", void 0);
__decorate([
    typeorm_1.Column({ nullable: true }),
    __metadata("design:type", Number)
], User.prototype, "mark", void 0);
__decorate([
    typeorm_1.OneToMany(type => subject_1.Subject, subject => subject.user, { cascade: ["insert", "update"],
        eager: false }),
    __metadata("design:type", Array)
], User.prototype, "subjects", void 0);
__decorate([
    typeorm_1.ManyToOne(type => group_1.Group, group => group.users),
